...
We have our Windows 10 desktop configured, and identified the Ansible modules we want to use. Here's the completed playbook, based on the previous one we created for [Linux](https://github.com/shaneboulden/functional-verification-ansible):
```
