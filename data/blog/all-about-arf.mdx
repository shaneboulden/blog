...
A quick disclaimer - the first part of this article is pretty heavy with XML. You can skip to the [ARF in Action](/blog/arf-in-action#arf-in-action) section if you want to skip the XML deep-dive. 
