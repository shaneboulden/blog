---
title: Automating FortiGate with Ansible
date: '2023-01-17'
tags: ['security', 'open', 'source','ansible','fortigate','aws']
draft: false
...
TASK [Remove source port configuration] **************************************************************************************************changed: [3.26.178.2]

PLAY RECAP *******************************************************************************************************************************3.26.178.2                 : ok=1    changed=1    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0
```
...
In this article I looked at automating short-term mitigations for FortiGate devices. We mitigated a critical CVE by disabling the SSL-VPN configuration, using an Ansible playbook.
