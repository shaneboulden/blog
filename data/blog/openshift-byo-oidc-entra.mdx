...
Firstly we need a Microsoft Entra ID app registration. To create one, login to the Azure portal, and navigate to the App registrations blade , then click on “New registration” to create a new application.




### Integrating Microsoft Entra as a direct OpenID Connect provider
I mentioned earlier in this article that one of the great new features in OpenShift 4.20 is direct OpenID Connect integration with OpenShift. 
