...
...
```
The release image is immutable. Because the release image is signed, and immutable, the contents (container image references used to pull OpenShift components) can be trusted.
