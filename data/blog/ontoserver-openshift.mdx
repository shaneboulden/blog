...
![meme](https://giphy.com/embed/RsDFTZQe5eVjQ4T5DA)
...
You'll need a licence to use Ontoserver, which is available CSIRO [here](https://ontoserver.csiro.au/site/contact-us/ontoserver-contact-form/). Once you have a license you'll be provided a username and password for [quay.io](https://quay.io), where the AEHRC Ontoserver container images are hosted.
