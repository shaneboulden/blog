...
images: ['/static/images/linkedin-banners/registryless-install.png']
draft: false
...
And of course, one of my favourite additions to OpenShift 4.20 is the registry-less ISO deployment method for OpenShift Virtualization. This will available in a [technology preview](https://access.redhat.com/solutions/21101) in a later release of OpenShift 4.20, and allows you to deploy a fully-functioning OpenShift Virtualization Engine cluster simply using an ISO, even in air-gapped or disconnected environments.
...
While we wait for the OpenShift 4.20 Technology Preview, the registry-less install is available in [Developer Preview](https://access.redhat.com/articles/6966848) with OpenShift 4.19. Let's take a look!
