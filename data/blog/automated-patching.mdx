...
draft: false
summary: 'RSA Conference 2022 again highlighted that many data breaches are due to unpatched systems. In this article I look at some of the technologies available to help organisations updates are applied across their hybrid cloud environments'
---
...
If you want to explore the capabilities that Red Hat Insights provides, you can find the console [here](https://console.redhat.com/). If you're new to Ansible, you can find some self-paced labs [here](https://www.ansible.com/products/ansible-training) to explore the platform and capabilities. 
