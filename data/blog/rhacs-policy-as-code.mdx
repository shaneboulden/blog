...
<Zoom>
![gitops-app1](/static/images/policy-as-code/gitops-app1.png)
</Zoom>

<Zoom>
![gitops-app2](/static/images/policy-as-code/gitops-app2.png)
</Zoom>


#### Add the policy to ArgoCD, and set it to apply to the acs-central namespace

#### Modify the policy via code to add enforcement actions