...
Generative AI has some novel applications for security, and I think one of the really fascinating applications is use in 'honeypots'. In this article I want to take a closer look at honeypots and their use in cybersecurity, and explore how generative AI helps us to make more capable and less expensive honeypots. I think this is fascinating because it's also focused on Generative AI and people; honeypots are designed to deceive people, and this article focuses on how we can create *even more deceptive* honeypots, enabled by AI.
...
For this article, I want to showcase how you can run inference entirely within an OpenShift cluster, supporting a honeypot deployment. The reason for this is that you may want to host this deployment model on cloud, or in your own datacenter, and I want to show how you can deploy the AI infrastructure for this application anywhere you need it. 

This also supports a 'data sovereignty' model. I don't necessarily want the data provided by threat actors to my honeypot to be recorded on a cloud service - I want it recorded on infrastructure I control, where I can manage it, and have complete control over where the data is captured and stored. OpenShift AI enables me to manage the complete lifecycle of the application - from the hardware and GPU, to the container image hosting the model, through to the inference endpoints and how they're exposed.
