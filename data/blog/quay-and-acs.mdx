...
If you have created an organisation, you will now have additional menu items - Teams and Membership, Default Permissions, Usage Logs, and Applications. Select `Applications`, and you'll see a entry to create an OAuth application. 
